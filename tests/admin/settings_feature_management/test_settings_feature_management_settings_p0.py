...
# ═══════════════════════════════════════════════════════════════
# ═══════════════════════════════════════════════════════════════
# AdminSettingsFeatureManagement - P0
...
logger = TestLogger('settings_feature_management_settings' + "_p0")
...
def test_p0_page_load(auth_page: Page):
    ...
    po.take_screenshot('settings_feature_management_settings' + "_p0_page_load", full_page=True)
