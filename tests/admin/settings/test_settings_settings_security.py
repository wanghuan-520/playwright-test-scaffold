...
logger = TestLogger('settings_settings' + "_security")
...
def test_security_unauth_redirects_to_login(unauth_page: Page):
    ...
    page.screenshot(path=f"screenshots/settings_settings_security_unauth_redirect.png", full_page=True)
...
def test_security_xss_payload_no_dialog(auth_page: Page):
    ...
    selectors = ['role=textbox[name="Default from address"]',
 'role=textbox[name="Default from display name"]',
 'role=textbox[name="Domain"]',
 'role=textbox[name="Host"]',
 ...
 'role=textbox[name="User name"]']
    ...
    page.screenshot(path=f"screenshots/settings_settings_security_xss_no_dialog.png", full_page=True)
