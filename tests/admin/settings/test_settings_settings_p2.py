...
from tests.admin.settings._helpers import assert_not_redirected_to_login
from utils.logger import TestLogger

logger = TestLogger('settings_settings' + "_p2")
...
def test_p2_fields_visible(auth_page: Page):
 ...
 'role=textbox[name="User name"]']
    ...
    po.take_screenshot('settings_settings' + "_p2_fields_visible", full_page=True)
...
def test_p2_keyboard_tab_navigation(auth_page: Page):
 ...
 'role=textbox[name="User name"]']
    ...
    po.take_screenshot('settings_settings' + "_p2_keyboard_tab")
    logger.end(success=True)
