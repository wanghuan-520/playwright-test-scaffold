...
logger = TestLogger('admin' + "_security")
...
def test_security_unauth_redirects_to_login(unauth_page: Page):
    ...
    page.screenshot(path=f"screenshots/admin_security_unauth_redirect.png", full_page=True)
...
def test_security_xss_payload_no_dialog(auth_page: Page):
    ...
    page.screenshot(path=f"screenshots/admin_security_xss_no_dialog.png", full_page=True)
