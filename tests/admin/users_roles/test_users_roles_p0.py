...
logger = TestLogger('users_roles' + "_p0")
...
def test_p0_page_load(auth_page: Page):
    ...
    po.take_screenshot('users_roles' + "_p0_page_load", full_page=True)
...
def test_p0_happy_path_update_save_with_rollback(auth_page: Page):
    ...
    try:
        with allure.step('修改字段并保存'):
            ...
            po.take_screenshot('users_roles' + '_p0_before_save')
            click_save(page)
