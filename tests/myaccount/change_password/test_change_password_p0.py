...
API（docs/requirements/account-profile-field-requirements.md）：
- POST /api/vibe/change-password
- 需要认证
...
@allure.description(
    """
测试点：
- 页面可打开（/account/password）且核心控件可见
- 核心控件：Current Password、New Password、Confirm Password、Update Password 按钮
