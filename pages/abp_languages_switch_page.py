# ═══════════════════════════════════════════════════════════════
# AbpLanguagesSwitch Page Object
# Generated: 2025-12-25 09:21:32
# ═══════════════════════════════════════════════════════════════
"""
AbpLanguagesSwitch 页面对象
...
class AbpLanguagesSwitchPage(BasePage):
    ...
    URL = 'https://localhost:3000/Abp/Languages/Switch'
    page_loaded_indicator = 'role=button[name="Open Next.js Dev Tools"]'
    ...
    def navigate(self) -> None:
        """导航到页面"""
        logger.info(f"导航到 AbpLanguagesSwitch 页面")
        self.goto(self.URL)
